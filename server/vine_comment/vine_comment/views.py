...
class CommentView(TemplateView):
    ...
    template_inside_cb = 'plugin/comment_view_inside_comment_board.html'
    template_raw = 'plugin/comment_view_raw.html'
    template_meta = 'plugin/comment_view_meta.html'
    template_list = 'plugin/comment_list.html'
    ...
    def get(self, request, *args, **kwargs):
        ...
        if flag == 'raw':
            template_name = 'plugin/comment_list_raw.html'
...
class AccountView(TemplateView):
    template_name = 'plugin/account_view.html'
...
class LetterView(TemplateView):
    template_name = 'plugin/letter_view.html'
...
class SettingView(TemplateView):
    template_name = 'plugin/setting_view.html'
...
class AccountRawView(TemplateView):
    template_name = 'plugin/account_raw.html'
...
class LetterRawView(TemplateView):
    template_name = 'plugin/letter_raw.html'
...
class SettingRawView(TemplateView):
    template_name = 'plugin/setting_raw.html'
...
class CommentsTagView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        flag = kwargs['flag']
        if flag == 'simple':
            self.template_name = 'plugin/comments_tag_simple.html'
        if flag == 'raw':
            self.template_name = 'common/comments_tag_raw.html'
        if flag == 'plug':
            self.template_name = 'plugin/comments_you_like.html'
...
class CommentShowNewListView(TemplateView):
    template_name = 'plugin/comments_plugin_new.html'
...
class CommentShowHotListView(TemplateView):
    template_name = 'plugin/comments_plugin_hot.html'
...
class CommentShowRelevantListView(TemplateView):
    template_name = 'plugin/comments_plugin_relevant.html'
...
class DanmuView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if url_b64 == self.base64_default_str:
            comments = Comment.objects.all()[0:10]
        else:
