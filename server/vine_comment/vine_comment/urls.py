...
urlpatterns += patterns('',
    ...
    url(r'^comments/hot/(?P<days>.*?)/?$', CommentsHotView.as_view(), name='site/comments_hot'),
    url(r'^comments/up/(?P<days>.*?)/?$', CommentsUpView.as_view(), name='site/comments_up'),
    url(r'^comments/debate/(?P<days>.*?)/?$', CommentsDebateView.as_view(), name='site/comments_debate'),
    url(r'^comments/best/?$', CommentsBestView.as_view(), name='site/comments_best'),
    url(r'^comments/tag/(?P<flag>.*?)/?$', CommentsTagView.as_view(), name='site/comments_tag'),
    url(r'^comments/related/(?P<url_b64>.*?)/?$', CommentsRelatedView.as_view(), name='comments_related'),
    url(r'^comments/newest/?$', CommentsNewestView.as_view(), name='site/comments_newest'),
