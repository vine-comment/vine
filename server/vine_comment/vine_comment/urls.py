...
from registration.backends.simple.views import RegistrationView as RegistrationSimpleView
...
urlpatterns += patterns('',
    ...
    url(r'^danmu/(?P<url_b64>.*?)/?$', DanmuView.as_view(), name='danmu'),
    url(r'^ajax/most_active_users/?$', MostActiveUsersView.as_view(), name='most_active_users_ajax'),
