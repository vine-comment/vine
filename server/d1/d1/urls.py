...
urlpatterns += patterns('',
    ...
    url(r'^home/up/(?P<days>.*?)/?$', HomeUpView.as_view(), name='home_up'),
    url(r'^home/debate/(?P<days>.*?)/?$', HomeDebateView.as_view(), name='home_debate'),
    url(r'^home/best/?$', HomeBestView.as_view(), name='home_best'),
    url(r'^home/newest/?$', HomeNewestView.as_view(), name='home_newest'),
